                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" id="title" name="title"
                                       ...
                                       placeholder="Enter the event name" value="{{ old('title') }}"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" id="start_date" name="start_date"
                                       ...
                                       placeholder="Enter the event start date" value="{{ old('start_date') }}"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="time" id="start_time" name="start_time"
                                       ...
                                       placeholder="Enter the event start date" value="{{ old('start_time') }}"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" id="end_date" name="end_date"
                                       ...
                                       placeholder="Enter the event end date" value="{{ old('end_date') }}"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="time" id="end_time" name="end_time"
                                       ...
                                       placeholder="Enter the event end date" value="{{ old('end_time') }}"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <textarea name="location" id="location" cols="20" rows="5"
                                          ...
                                          autofocus>{{ old('location') }}</textarea>
